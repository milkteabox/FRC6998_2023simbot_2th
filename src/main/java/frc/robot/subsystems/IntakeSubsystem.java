...
public class IntakeSubsystem extends SubsystemBase
{
    ...
    private void configAngleMotor(){
        ...
        intake_Angle_L_Motor.getEncoder().setPositionConversionFactor(360);
        ...
        intake_Angle_R_Motor.getEncoder().setPositionConversionFactor(360);
        ...
        intake_Angle_R_Motor.follow(intake_Angle_L_Motor);
